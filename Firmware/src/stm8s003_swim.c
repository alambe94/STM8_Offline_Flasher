...
uint8_t SWIM_Unlock_Flash_All(void)
{
  ...
  if(devices & SWIM_PIN_1)
  {
    SWIM_Unlock_Flash(SWIM_PIN_1);
  }
  if(devices & SWIM_PIN_2)
  {
    SWIM_Unlock_Flash(SWIM_PIN_2);
  }
  if(devices & SWIM_PIN_3)
  {
    SWIM_Unlock_Flash(SWIM_PIN_3);
  }
  if(devices & SWIM_PIN_4)
  {
    SWIM_Unlock_Flash(SWIM_PIN_4);
  }
  if(devices & SWIM_PIN_5)
  {
    SWIM_Unlock_Flash(SWIM_PIN_5);
  }
  if(devices & SWIM_PIN_6)
  {
    SWIM_Unlock_Flash(SWIM_PIN_6);
  }
  else
  {
    //zero mcu to copy
